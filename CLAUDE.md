...
| `biweekly` | 兩欄目一張稿：①過去 14 日全站熱門前 10（同 weekly 邏輯）②過去 14 日內**曾被置頂過**的所有文章，按頻道分組。先補當日快照、tag 作者 | 每月 1、15 號 10:00 | `digest-biweekly.yml` |

cron 以 UTC 計：週一 06:00 HKT = 週日 22:00 UTC；每日 07:00 = 23:00 UTC；1/15 號 10:00 = 02:00 UTC。
